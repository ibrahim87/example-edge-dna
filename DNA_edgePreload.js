...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "http://cdnjs.cloudflare.com/ajax/libs/gsap/latest/TweenMax.min.js", user: true },
      { load: "js/rainbowvis.js", user: true },
      { load: "DNA_edge.js"},
      { load: "DNA_edgeActions.js"}];
...
var plSTF="none",ctrPlS="none",minPlW="0",maxPlW=undefined,plWidth="900px",plHeight="700px";
